  ...
  var a = "undefined" != typeof window ? window : this,
    e = (a.Glider = function (e, t) {
      ...
      if (
        ...
        (o.animate_id = o.page = o.slide = o.scrollLeft = 0),
        (o.arrows = {}),
        (o._opt = o.opt),
        o.opt.skipTrack)
      )
  ...
  return (
    ...
    (t.updateControls = function (e) {
      ...
      d.opt.rewind ||
        ...
        d.arrows.next &&
          (d.arrows.next.classList.toggle(
            "disabled",
            Math.ceil(d.scrollLeft + d.containerWidth) >=
        ...
        (d.slide = Math.round(d.scrollLeft / d.itemWidth)),
        (d.page = Math.round(d.scrollLeft / d.containerWidth));
      ...
      1 === Math.floor(d.opt.slidesToShow) && (h = 0),
        d.scrollLeft + d.containerWidth >= Math.floor(d.trackWidth) &&
    ...
    (t.scrollTo = function (t, o, i) {
      var r = this,
        ...
        n = function () {
          ...
          (r.scrollLeft =
            r.scrollLeft + (t - r.scrollLeft) * r.opt.easing(0, e, 0, 1, o)),
            (r.ele.scrollLeft = r.scrollLeft),
            e < o && l === r.animate_id
              ? a.requestAnimationFrame(n)
              : ((r.ele.scrollLeft = r.scrollLeft = t), i && i.call(r));
        };
      a.requestAnimationFrame(n);
    }),
